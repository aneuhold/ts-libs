...
import WorkoutMesocycleService from './WorkoutMesocycle.service.js';
import {
...
describe('Unit Tests', () => {
  describe('generateOrUpdateMesocycle', () => {
    ...
    describe('cross-mesocycle continuity', () => {
      ...
      it('should use previous performance data when exercise has lastAccumulationSessionSets populated', () => {
        // Create a CTO with lastAccumulationSessionSets simulating a previous mesocycle's actual performance
        ...
        const lastAccumulationSessionExercise = workoutTestUtil.createSessionExercise({
          exercise: workoutTestUtil.STANDARD_EXERCISES.barbellSquat
        });
        ...
        const exerciseCTOWithHistory = workoutTestUtil.createExerciseCTO({
          ...
          calibration: workoutTestUtil.STANDARD_CALIBRATIONS.barbellSquat,
          equipmentType: workoutTestUtil.STANDARD_EQUIPMENT_TYPES.barbell,
          lastAccumulationSessionSets: [lastFirstSet],
      ...
      it('should use calibration formula when exercise CTO has no prior performance data', () => {
        // CTO with calibration but no lastAccumulationSessionSets or lastAccumulationSessionExercise (new exercise)
